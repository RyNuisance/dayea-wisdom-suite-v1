...
class WebTester:
    ...
    def run(self) -> dict:
        ...
        if not web_targets:
            self._update_progress(100, "⚠️ No web targets found in scope")
        ...
        for file_info in sensitive_list:
            ...
            try:
                ...
                if status_code in [200, 403]:
                    ...
                    self.logger.warning(f"  ⚠️  Sensitive file found [{status_code}]: {test_url}")
    ...
    def _test_xss(self, base_url: str, forms: list, pages: set):
        ...
        xss_probe = "<script>alert('DAYEA WISDOM SUITE_XSS_TEST')</script>"
        marker    = "DAYEA WISDOM SUITE_XSS_TEST"
    ...
    def _test_cors(self, base_url: str):
        ...
        try:
            ...
            req.add_header('User-Agent', 'DayeaWisdomSuite/1.0 Security Assessment')
    ...
    def _fetch(self, url: str, follow_redirects: bool = True) -> tuple | None:
        ...
        try:
            ...
            req.add_header('User-Agent', 'Mozilla/5.0 DayeaWisdomSuite/1.0 Security Assessment')
