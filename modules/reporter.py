...
ACCENT_GREEN = colors.HexColor('#2a7de0')   # Dayea brand blue
...
class ReportBuilder:
    ...
    def build(self, scan_data: dict, output_path: str) -> str:
        ...
        doc = SimpleDocTemplate(
            ...
            creator="Dayea — Professional Security Testing Framework"
        )
    ...
    def _draw_cover_decorations(self, canv, doc):
        ...
        canv.drawString(MARGIN, 6*mm, "Dayea v1.0 — Confidential Security Report")
    ...
    def _draw_page_header_footer(self, canv, doc):
        ...
        canv.drawString(MARGIN, PAGE_H - 7*mm, "  DAYEA — SECURITY ASSESSMENT REPORT")
    ...
    def _build_findings_overview(self, scan_data: dict) -> list:
        ...
        for module_name, module_results in modules_data.items():
            ...
            module_labels = {
                'scout':      ('  Recon',      'Network Scanner',          ACCENT_CYAN),
    ...
    def _build_appendix(self, scan_data: dict) -> list:
        ...
        story.append(Paragraph(
            "This assessment was performed using Dayea v1.0, a professional "
